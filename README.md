...
## No permission is granted to use, copy, run, modify, distribute, or reproduce this software or any part of it without explicit written permission from the author.
